...
public class WrapperRepEntityImages_EntityId extends WrapperRepository<EntityImages> implements IEntityImagesRepository , IAttachRepository<EntityImages>{

	int id;
	String filter;
	public WrapperRepEntityImages_EntityId(IEntityImagesRepository repository, int id){
		super(repository);
		this.id = id;
		filter = String.format("EntityId = %d", id);
	}

	public WrapperRepEntityImages_EntityId(IEntityImagesRepository repository, int id, int op){
		this(repository,id);
