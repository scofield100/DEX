...
public class ActivityClientDetails extends Activity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentClientDetails.class
							,FragmentClientDishFavoritesDishList.class
							,FragmentClientEntityFavoritesEntityList.class
							,FragmentClientOrderList.class
