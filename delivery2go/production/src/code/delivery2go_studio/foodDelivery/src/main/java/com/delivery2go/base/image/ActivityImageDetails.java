...
public class ActivityImageDetails extends Activity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentImageDetails.class
							,FragmentEntityImagesEntityList.class
							,FragmentDishImagesDishList.class
							,FragmentImageDishList.class
							,FragmentImageEntityMenuList.class
							,FragmentImageOrderList.class
							,FragmentImageEntityList.class

                       },new String[]{
                                getString(R.string.image)
							,getString(R.string.entities)
