...
public class ActivityOrderDishDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="OrderDish";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentOrderDishDetails.class
							,FragmentOrderDishOrderDishAddonsList.class

                       },new String[]{
                                getString(R.string.orderdish)
							,getString(R.string.orderdishaddonses)
