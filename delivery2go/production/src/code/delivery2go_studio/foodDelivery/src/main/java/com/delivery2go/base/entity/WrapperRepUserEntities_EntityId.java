...
public class WrapperRepUserEntities_EntityId extends WrapperRepository<UserEntities> implements IUserEntitiesRepository , IAttachRepository<UserEntities>{

	int id;
	String filter;
	public WrapperRepUserEntities_EntityId(IUserEntitiesRepository repository, int id){
		super(repository);
		this.id = id;
		filter = String.format("EntityId = %d", id);
	}

	public WrapperRepUserEntities_EntityId(IUserEntitiesRepository repository, int id, int op){
		this(repository,id);
