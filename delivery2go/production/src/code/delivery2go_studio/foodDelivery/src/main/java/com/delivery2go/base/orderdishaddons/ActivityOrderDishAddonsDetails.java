...
public class ActivityOrderDishAddonsDetails extends Activity{

public static final String ID ="OrderDishAddons";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			...
			.add(R.id.content, new FragmentOrderDishAddonsDetails())
			.commit();
		}
