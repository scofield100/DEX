...
public class ActivityDishDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="Dish";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentDishDetails.class
							,FragmentDishCategoriesDishCategoryList.class
							,FragmentDishImagesImageList.class
							,FragmentDishDishSizePriceList.class
							,FragmentDishDishReviewList.class
                       },new String[]{
                                getString(R.string.dish)
							,getString(R.string.dishcategories)
							,getString(R.string.images)
							,getString(R.string.dishsizeprices)
