...
public class ActivityEntityCategoriesDetails extends Activity{

public static final String ID ="EntityCategories";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			...
			.add(R.id.content, new FragmentEntityCategoriesDetails())
			.commit();
		}
