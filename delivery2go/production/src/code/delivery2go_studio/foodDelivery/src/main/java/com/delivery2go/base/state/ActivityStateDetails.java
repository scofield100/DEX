...
public class ActivityStateDetails extends Activity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentStateDetails.class
							,FragmentStateCityList.class
							,FragmentStateEntityList.class
