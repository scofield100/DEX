...
public class ActivityDishSizeDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="DishSize";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentDishSizeDetails.class
							,FragmentDishSizeDishSizePriceList.class

                       },new String[]{
                                getString(R.string.dishsize)
