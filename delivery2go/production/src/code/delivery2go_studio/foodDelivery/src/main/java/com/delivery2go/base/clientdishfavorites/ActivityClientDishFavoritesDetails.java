...
public class ActivityClientDishFavoritesDetails extends Activity{

public static final String ID ="ClientDishFavorites";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			...
			.add(R.id.content, new FragmentClientDishFavoritesDetails())
			.commit();
		}
