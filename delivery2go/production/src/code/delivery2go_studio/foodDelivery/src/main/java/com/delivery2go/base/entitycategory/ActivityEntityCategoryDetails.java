...
public class ActivityEntityCategoryDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="EntityCategory";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentEntityCategoryDetails.class
							,FragmentEntityCategoriesEntityList.class

                       },new String[]{
                                getString(R.string.entitycategory)
