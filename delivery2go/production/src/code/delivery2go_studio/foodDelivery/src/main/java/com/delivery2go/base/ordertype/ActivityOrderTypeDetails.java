...
public class ActivityOrderTypeDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="OrderType";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentOrderTypeDetails.class
							,FragmentOrderTypeOrderList.class

                       },new String[]{
                                getString(R.string.ordertype)
