...
public class ActivityDishSizePriceDetails extends Activity  {

	public static final String ID ="DishSizePrice";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			getFragmentManager().beginTransaction()
					.add(R.id.content, new FragmentDishSizePriceDetails())
					.commit();
		}
