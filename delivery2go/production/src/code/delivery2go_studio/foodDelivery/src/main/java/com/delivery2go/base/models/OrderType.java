...
public class OrderType implements Serializable {
	...
	public OrderType(IEntityContext mapContext){
...
/****** START Inverse Navigation Properties ******************/
	...
	public IEntityCollection<Order> getOrders(){
		if(orders == null && mapContext!=null){
			orders=mapContext.getManyToOne(com.delivery2go.base.data.RepositoryManager.getInstance().getIOrderRepository(), Order.class, "OrderTypeId", Id);
		}
		return orders;
	}
