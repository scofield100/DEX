...
public class ActivityDishCategoryDetails extends Activity implements ActionBar.TabListener {

	public static final String ID ="DishCategory";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentDishCategoryDetails.class
							,FragmentDishCategoriesDishList.class

                       },new String[]{
                                getString(R.string.dishcategory)
