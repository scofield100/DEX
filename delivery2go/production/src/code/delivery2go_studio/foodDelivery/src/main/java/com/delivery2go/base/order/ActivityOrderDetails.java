...
public class ActivityOrderDetails extends Activity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
		        ...
		        public SectionsPagerAdapter(FragmentManager fm) {
                    ...
                    addPages(new Class[]{
                              FragmentOrderDetails.class
							,FragmentOrderOrderDishList.class

                       },new String[]{
                                getString(R.string.order)
							,getString(R.string.orderdishs)
