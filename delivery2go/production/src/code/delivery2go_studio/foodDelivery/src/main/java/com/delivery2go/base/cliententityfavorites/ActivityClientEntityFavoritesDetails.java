...
public class ActivityClientEntityFavoritesDetails extends Activity{

public static final String ID ="ClientEntityFavorites";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			...
			.add(R.id.content, new FragmentClientEntityFavoritesDetails())
			.commit();
		}
