...
public class ActivityDishCategoriesDetails extends Activity{

public static final String ID ="DishCategories";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null){
			...
			.add(R.id.content, new FragmentDishCategoriesDetails())
			.commit();
		}
