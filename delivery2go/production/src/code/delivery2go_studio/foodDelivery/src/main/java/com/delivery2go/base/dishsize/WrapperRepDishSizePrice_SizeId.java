...
public class WrapperRepDishSizePrice_SizeId extends WrapperRepository<DishSizePrice> implements IDishSizePriceRepository , IAttachRepository<DishSizePrice>{

	int id;
	String filter;
	public WrapperRepDishSizePrice_SizeId(IDishSizePriceRepository repository, int id){
		super(repository);
		this.id = id;
		filter = String.format("SizeId = %d", id);
	}

	public WrapperRepDishSizePrice_SizeId(IDishSizePriceRepository repository, int id, int op){
		this(repository,id);
